...
прагнень та внесків у спільні проекти, демонструючи чітке розуміння ролі та галузевих стандартів. Використовуй лише українську мову.
Відповідь надай у форматі об'єкту, де ключі - це рівні досвіду (початківець, середній та досвідчений), а значення - це рядок з резюме.`;
